                ...
                <form class="floating-labels m-t-40" action="{{Route('department.store')}}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <label for="area_title">Department Name</label>
                                <input type="text" class="form-control" id="area_title"  name="department_title">
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-b-5">
                                <textarea class="form-control" rows="4" id="input7" name="department_desccription"></textarea>
                                <span class="bar"></span>
