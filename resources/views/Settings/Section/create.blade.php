...
<div class="row">
    ...
    <!-- card -->
        <div class="card" style="height: 535px;">
            ...
            <!-- Create department -->
                <form class="floating-labels m-t-40" action="{{Route('section.store')}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group m-b-40">
                            <label for="area_title">Section Title</label>
                                <input type="text" class="form-control" id="area_title"  name="section_title">
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-b-5">
                                <textarea class="form-control" rows="4" id="input7" name="section_desccription"></textarea>
                                <span class="bar"></span>
