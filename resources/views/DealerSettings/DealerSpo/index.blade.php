...
<div class="row">
    ...
    <div class="card" style="height: 535px;">
            <div class="card-body">
            <div class="row">
                <div class="col-md-6" align="left"><h4 class="card-title">Dealer SPO List</h4></div>
                <div class="col-md-6" align="right"><a href="{{Route('dealersettings.spo.create')}}" class="btn btn-primary btn-sm">Add New SPO</a></div>
            </div>
                    ...
                    <table id="example" class="display" style="width:100%">
                        ...
                        @foreach($dealerspo as $dspo)
                            <tr>
                                ...
                                <td>{{$dspo->sop_name}}</td>
                                <td>{{$dspo->sop_nid}}</td>
                                <td>{{$dspo->sop_phone_number}}</td>
                                <td>{{$dspo->sop_address}}</td>
                                <td>
