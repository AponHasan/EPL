...
<div class="row">
    ...
    <!-- card -->
        <div class="card" style="height: 535px;">
            <!-- card body -->
            <div class="card-body">
            <h3>Create Dealer Area</h3>
            <!-- Create department -->
                <form class="floating-labels m-t-40" action="{{Route('dealersettings.area.postcreate')}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group m-b-40">
                            <label for="area_title">Area Title</label>
                                <input type="text" class="form-control" id="area_title"  name="area_title">
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-b-5">
                                <textarea class="form-control" rows="4" id="input7" name="area_description"></textarea>
                                <span class="bar"></span>
