...
<div class="row">
    ...
    <!-- card -->
        <div class="card" style="height: 535px;">
            <!-- card body -->
            <div class="card-body">
            <h3>Set Product Color</h3>
            <!-- Create department -->
                <form class="floating-labels m-t-40" action="{{Route('productcolors.store')}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group m-b-40">
                            <label for="area_title">Color Title</label>
                                <input type="text" class="form-control" id="area_title"  name="color_title">
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-b-5">
                                <textarea class="form-control" rows="4" id="input7" name="color_description"></textarea>
                                <span class="bar"></span>
    ...
    <table id="example" class="display" style="width:100%">
        ...
        @foreach($product_colors as $product_color)
            <tr>
                ...
                <td>{{$product_color->color_title}}</td>
                <td>
