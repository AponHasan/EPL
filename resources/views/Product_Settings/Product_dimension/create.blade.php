...
<div class="row">
    ...
    <!-- card -->
        <div class="card" style="height: 535px;">
            <!-- card body -->
            <div class="card-body">
            <h3>Set Product Dimension</h3>
            <!-- Create department -->
                <form class="floating-labels m-t-40" action="{{Route('productdimensions.store')}}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group m-b-40">
                            <label for="area_title">Dimension Title</label>
                                <input type="text" class="form-control" id="area_title"  name="dimensions_title">
                        ...
                        <div class="col-md-12">
                            <div class="form-group m-b-5">
                                <textarea class="form-control" rows="4" id="input7" name="dimensions_description"></textarea>
                                <span class="bar"></span>
    ...
    <div class="card" style="height: 535px;">
            <div class="card-body">
                <h4 class="card-title">Dimension List</h4>
    ...
    <table id="example" class="display" style="width:100%">
        ...
        @foreach($product_dimensions as $product_dimension)
            <tr>
                ...
                <td>{{$product_dimension->dimensions_title}}</td>
                <td>
