        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-9" align="right">
                    <a href="{{route('dealer.collection.dtarget')}}" class="btn btn-primary btn-sm">Target List</a>
                </div>
            </div>
        </div>
            <!-- card body -->
            ...
            <!-- Create department -->
                <form class="floating-labels m-t-40" action="{{Route('dealer.target.set')}}"method="POST">
                    @csrf
