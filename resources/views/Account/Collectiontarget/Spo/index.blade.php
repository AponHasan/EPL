        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-9" align="right">
                    <a href="{{route('spo.collection.starget.set')}}" class="btn btn-primary btn-sm">Target Set</a>
                </div>
            </div>
        </div>
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <thead>
                        ...
                        <tbody>
                        @foreach($spestars as $sptar)
                            <tr>
                                <td>{{$loop->iteration}}</td>
                                <td>{{$sptar->emp_name}}</td>
                                <td align="center">{{$sptar->from_date}} </br> TO </br> {{$sptar->to_date}}</td>
                                <td>{{$sptar->traget_amount}}</td>
                                <td>{{$sptar->achieve_commistion}} %</td>
                                <td>Calculeting..</td>
                                <td></td>
                            </tr>
                            @endforeach
