        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-9" align="right">
                    <a href="{{route('other.collection.otarget')}}" class="btn btn-primary btn-sm">Target List</a>
                </div>
            </div>
        </div>
            <!-- card body -->
            ...
            <!-- Create department -->
                <form class="floating-labels m-t-40" action="{{Route('other.target.set')}}"method="POST">
                    @csrf
                    <div class="row" style="margin-left:5%">
                        <div class="col-md-8">
                            <div class="form-group m-b-40">
                                <label style="position: inherit;">Employee</label>
                                <select class="form-control" style="padding: 0px 10px 10px 10;" name="emp_id">
                                <option value="">Select Emoloyee</option>
                                    @foreach($emps as $emp)
