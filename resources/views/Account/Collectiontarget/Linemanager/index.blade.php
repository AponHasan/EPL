        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-9" align="right">
                    <a href="{{route('linemanager.collection.lmtarget.set')}}" class="btn btn-primary btn-sm">Target Set</a>
                </div>
            </div>
        </div>
            <div class="card-body">
                    ...
                    <table id="example" class="display" style="width:100%">
                        ...
                        @foreach($lmtargets as $lmtar)
                            <tr>
                                ...
                                <td align="center">{{$lmtar->from_date}} </br> TO </br> {{$lmtar->to_date}}</td>
                                <td>{{$lmtar->traget_amount}}</td>
                                <td>{{$lmtar->achieve_commistion}} %</td>
                                <td>Calculeting..</td>
                                <td></td>
                            </tr>
                            @endforeach
